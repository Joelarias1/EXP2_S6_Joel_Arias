...
public class OrdenController {
    ...
    public ResponseEntity<OrdenDTO> actualizarOrden(@PathVariable Long id, @Valid @RequestBody OrdenDTO ordenDTO) {
        OrdenDTO ordenActualizada = ordenService.updateOrder(id, ordenDTO);
